	...
	<div style="margin: 5% 20% 5% 20% ; background: #fff; display: flex; border-radius: 15px;">
		...
		<div style="padding: 30px; flex-basis: 40%; border-radius: 15px;">
			<form action="Forgot.jsp" method="post">
				...
				<input type="password" name="newpsd" style="border: 0px solid transparent; border-bottom: 2px solid black; width: 100%; height: 50px;" placeholder="Enter your new password :"><br><br>
				<input type="submit" style="width: 100%; height: 50px; border-radius: 10px; background: #ADD8E6; border: 0px solid transparent;" value="Change Password"><br><br>
			</form>
			<br><br>
		...
		<div style="padding: 30px; padding-left:60px; flex-basis: 60%; background: #ADD8E6; border-radius: 15px;">
				<% 
					...
					if("done".equals(msg)){
				%>
						<h5 style="color: green; margin: 10px;"> Password Seccessfully Changed! </h5>	
				<% 
					}
				%>	
				<% 
				...
				%>
						<h5 style="color: red; margin: 10px;"> Unauthorized User! <br><i style="padding-left: 60px"> Please Register or Enter Currect fields! </i> </h5>
				<%
					}
				%>
